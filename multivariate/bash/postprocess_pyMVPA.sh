...
mv *.nii.gz raw
cd raw
for model in syntax_lang syntax_pic #ActPass_lang ActPass_pic RelCan_lang RelCan_pic #cross_verb_L2P cross_verb_P2L
do
	for indMap in `ls | grep _${model}_concat_cvsl.nii.gz`
	do
