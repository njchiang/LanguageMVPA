...
Models.ActPassDetector = ActPassMat;
...
Models.RelCanDetector = RelCanMat;
...
Models.SyntaxComplexity = SyntaxComplexityMat;
VerbMat=genModel;
...
Models.VerbHierarchy = VerbHierarchy;
